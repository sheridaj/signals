...
class ObjectiveCGenerator(iOSGenerator):
    ...
    RESERVED_WORDS = iOSGenerator.RESERVED_WORDS + ["auto","break","case","char","const",
...
class SwiftGenerator(iOSGenerator):
    ...
    RESERVED_WORDS = iOSGenerator.RESERVED_WORDS + ["class","deinit","enum","extension",
    	"func","import","init","internal","let","operator","prvate","protocol","public",
    	"static","struct","typealias","var","break","case","continue","default","do","else",
    	"fallthrough","for","if","in","return","switch","where","while","as","dynamicType",
    	"false","is","nil","self","Self","super","true","COLUMN","FILE","FUNCTION","LINE",
